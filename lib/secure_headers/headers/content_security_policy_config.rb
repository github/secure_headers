  ...
  module DynamicConfig
    ...
    module ClassMethods
      def from_self(instance)
        ...
        new_instance.child_src = instance.child_src
        new_instance.connect_src = instance.connect_src
        new_instance.default_src = instance.default_src
        new_instance.font_src = instance.font_src
        new_instance.form_action = instance.form_action
        new_instance.frame_ancestors = instance.frame_ancestors
        new_instance.frame_src = instance.frame_src
        new_instance.img_src = instance.img_src
        new_instance.manifest_src = instance.manifest_src
        new_instance.media_src = instance.media_src
        new_instance.navigate_to = instance.navigate_to
        new_instance.object_src = instance.object_src
        new_instance.plugin_types = instance.plugin_types
        new_instance.prefetch_src = instance.prefetch_src
        new_instance.preserve_schemes = instance.preserve_schemes
        new_instance.report_only = instance.report_only
        new_instance.report_uri = instance.report_uri
        ...
        new_instance.style_src = instance.style_src
        new_instance.worker_src = instance.worker_src
